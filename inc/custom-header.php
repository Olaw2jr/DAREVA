<?php
/**
 * Custom Header functionality for DAREVA
 *
 * @package WordPress
 * @subpackage DAREVA
 * @since DAREVA 1.0
 ...
 *
 * @uses dareva_header_style()
 */
function dareva_custom_header_setup() {
	$color_scheme        = dareva_get_color_scheme();
	$default_text_color  = trim( $color_scheme[4], '#' );

	/**
	 * Filter DAREVA custom-header support arguments.
	 *
	 * @since DAREVA 1.0
	 *
	 * @param array $args {
...
add_action( 'after_setup_theme', 'dareva_custom_header_setup' );
...
if ( ! function_exists( 'dareva_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog.
 *
 * @since DAREVA 1.0
 *
 * @see dareva_custom_header_setup()
 */
function dareva_header_style() {
	...
	?>
	<style type="text/css" id="dareva-header-css">
	<?php
 ...
 */
function dareva_header_background_color_css() {
	$color_scheme            = dareva_get_color_scheme();
	...
	wp_add_inline_style( 'dareva-style', sprintf( $css, $header_background_color ) );
}
add_action( 'wp_enqueue_scripts', 'dareva_header_background_color_css', 11 );
 ...
 * @since DAREVA 1.0
 */
function dareva_sidebar_text_color_css() {
	$color_scheme       = dareva_get_color_scheme();
	...
	// If we get this far, we have custom styles. Let's do this.
	$sidebar_link_color_rgb     = dareva_hex2rgb( $sidebar_link_color );
	...
	wp_add_inline_style( 'dareva-style', sprintf( $css, $sidebar_link_color, $sidebar_text_color, $sidebar_border_color, $sidebar_border_focus_color ) );
}
add_action( 'wp_enqueue_scripts', 'dareva_sidebar_text_color_css', 11 );
